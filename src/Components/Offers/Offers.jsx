...
export default function Offers() {
  return (
    ...
    <div className='w-6/12 relative mr-10 group-hover:mix-blend-soft-light  hover:translate-y-1.5 ease-in-out duration-500 '>
    ...
    <div className='w-6/12 relative  group-hover:mix-blend-soft-light hover:translate-y-1.5 ease-in-out duration-500 '>
